((typeof self !== 'undefined' ? self : this)["webpackJsonp_wix_ui_santa"] = (typeof self !== 'undefined' ? self : this)["webpackJsonp_wix_ui_santa"] || []).push([[64],{
...
var getSDK_1 = __webpack_require__(/*! ./getSDK */ 668);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../webpack/buildin/global.js */ 23), __webpack_require__(/*! ./../process/browser.js */ 65)))
...
/* WEBPACK VAR INJECTION */(function(global, setImmediate) {(function (global, factory) {
    ...
    */
    ...
    var out='<div class="'+(props.styles.playControl)+'" data-playable-hook="playback-control"> <button class="'+(props.styles.playbackToggle)+' '+(props.styles.controlButton)+'" data-playable-hook="playback-control" aria-label="'+(props.texts.label)+'" type="button" tabindex="0"/></div>';return out;
    }
    ...
    var out='<div class="'+(props.styles.fullScreenControl)+'" data-playable-hook="full-screen-control"> <button class="'+(props.styles.fullScreenToggle)+' '+(props.styles.controlButton)+'" data-playable-hook="full-screen-button" aria-label="'+(props.texts.label)+'" type="button" tabindex="0"/></div>';return out;
    }
    ...
    var out='<div class="'+(props.styles.icon)+'"> <svg class="'+(props.styles.icon_small)+'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 15"> <g fill="#FFF" fill-rule="evenodd" class="'+(props.themeStyles.pictureInPictureSvgFill)+'"> <path d="M6 13H0V0h15v5h-1.992V1.96H2.027V11H6z"/> <path d="M8 7h9v8H8V7zm2 2v4h5V9h-5z"/> </g> </svg> <svg class="'+(props.styles.icon_big)+'" viewBox="0 0 24 21" version="1" xmlns="http://www.w3.org/2000/svg"> <g fill="#FFF" fill-rule="evenodd"> <path d="M12 10h12v11H12V10zm2 2v7h8v-7h-8z"/> <path d="M9 19H0V0h22v7h-2V2H2v15h7z"/> </g> </svg></div>';return out;
    }

    function dot_tpl_src_modules_ui_controls_pictureInPicture_templates_exitPictureInPicture_dot(props
    ) {
    var out='<div class="'+(props.styles.icon)+'"> <svg class="'+(props.styles.icon_small)+'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 15"> <g fill="#FFF" fill-rule="evenodd" class="'+(props.themeStyles.pictureInPictureSvgFill)+'"> <path d="M7 13H0V0h15v5h-2.006V2.003H2.019V11H7z"/> <path d="M16 9H9V7h7z"/> <path d="M11 14V7H9v7z"/> <path d="M16.364 12.95l-1.414 1.414L10 9.414 11.414 8z"/> </g> </svg> <svg class="'+(props.styles.icon_big)+'" viewBox="0 0 24 21" version="1" xmlns="http://www.w3.org/2000/svg"> <g fill="#FFF" fill-rule="evenodd"> <path d="M23 14h-8v-2h8z"/> <path d="M17 20v-8h-2v8z"/> <path d="M24 20l-1 1-7-6 2-2z"/> <path d="M12 19H0V0h22v9h-2V2H2v15h10z"/> </g> </svg></div>';return out;
    }
    ...
    var styles$18 = {"controlButton":"picture-in-picture__controlButton___1gCAB","hidden":"picture-in-picture__hidden___17cZh","pictureInPictureControl":"picture-in-picture__pictureInPictureControl___3PS8W","pictureInPictureToggle":"picture-in-picture__pictureInPictureToggle___68YJ9","icon":"picture-in-picture__icon___HLiwK","icon_small":"picture-in-picture__icon_small___2lbgz","icon_big":"picture-in-picture__icon_big___3eWYY","inPictureInPicture":"picture-in-picture__inPictureInPicture___33ewm"};
    styleInject(css$18);
    ...
    var out='<div class="'+(props.styles.buttonWrapper)+'"> <button class="'+(props.styles.downloadButton)+' '+(props.styles.controlButton)+'" data-playable-hook="download-button" aria-label="'+(props.texts.label)+'" type="button" tabindex="0"> <div class="'+(props.styles.icon)+'"> <svg viewBox="0 0 24 21" xmlns="http://www.w3.org/2000/svg"> <path d="M11 10.586V0h2v10.825L18.071 6l1.414 1.414-7.085 6.743-.329.328L5 7.415 6.414 6 11 10.586zM0 19h24v2H0v-2z" fill="#FFF" fill-rule="evenodd"/> </svg> </div> </button></div>';return out;
    }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../webpack/buildin/global.js */ 23), __webpack_require__(/*! ./../../../timers-browserify/main.js */ 666).setImmediate))
...
var _browser = __webpack_require__(/*! ./browser */ 176);

var _env = __webpack_require__(/*! ./env */ 106);
...
var assert = __webpack_require__(/*! ./assert */ 368);

var _require = __webpack_require__(/*! ./utils/collections */ 682),
    mapValues = _require.mapValues,
    filterValues = _require.filterValues;

var promise = __webpack_require__(/*! ./utils/promise */ 683);
var log = __webpack_require__(/*! ./utils/log */ 684);
var EventBuffer = __webpack_require__(/*! ./utils/event-buffer */ 685);
...
exports.default = __webpack_require__.stylable.create(
  ...
  {"root":"VideoPlayer4111471387--root","playButton":"VideoPlayer4111471387--playButton","skins":"'wixui.skins.VideoPlayer'","backgroundColor":"color_10","font":"font_8","fontColor":"color_2","borderColor":"color_2","borderSize":"0","boxShadow":"none","textSizeScale":"1px","playButtonSize":"50px","playButtonMobileSize":"30px"},
  "",
  7,
  /*! ./components/VideoPlayer/VideoPlayer.st.css */ 370
);
...
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + ".Video3333624439--root{position: relative}\n" + $id + " .Video3333624439--playerContainer{position: relative;height: 100%;width: 100%;background-color: #000}\n" + $id + " .Video3333624439--playerContainer iframe{height: 100%;width: 100%;visibility: visible}\n" + $id + " .Video3333624439--cover{position: absolute;top: 0;left: 0;height: 100%;width: 100%;background: #000 50% 50% no-repeat;background-size: cover;cursor: pointer}\n" + $id + " .Video3333624439--cover.Video3333624439--transparentOverlay{background: transparent}\n" + $id + " .Video3333624439--overlay{display: flex;height: 100%;justify-content: center;flex-direction: column;align-items: center;background-color: rgba(0,0,0,0.35)}\n" + $id + " .Video3333624439--title{margin: 0 15px 15px;text-align: center}\n" + $id + ".VideoPlayer4111471387--root{box-shadow: " + $params["boxShadow"] + ";border: " + $params["borderSize"] + " solid " + $params["borderColor"] + ";margin-top: calc(-1 * " + $params["borderSize"] + ");margin-left: calc(-1 * " + $params["borderSize"] + ")}\n" + $id + ".VideoPlayer4111471387--root .Video3333624439--title{font: " + $params["font"] + ";color: " + $params["fontColor"] + ";margin: 0 0 15px;padding: 0 .2em;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;max-height: 2.8em}\n" + $id + ".VideoPlayer4111471387--root[data-videoplayer4111471387-ismobileview] .Video3333624439--title{font-size: calc(18 * " + $params["textSizeScale"] + ");margin: 0 0 10px}\n" + $id + ".VideoPlayer4111471387--root .Video3333624439--overlay{background-color: " + $params["backgroundColor"] + ";padding: 0 10%;transition: opacity .2s ease}\n" + $id + ".VideoPlayer4111471387--root .VideoPlayer4111471387--playButton{display: block;width: " + $params["playButtonSize"] + ";height: " + $params["playButtonSize"] + ";padding: 0;border: 0;background: transparent;box-sizing: border-box;cursor: pointer;transition: opacity .2s ease}\n" + $id + ".VideoPlayer4111471387--root .VideoPlayer4111471387--playButton:hover{opacity: .8}\n" + $id + ".VideoPlayer4111471387--root[data-videoplayer4111471387-ismobileview] .VideoPlayer4111471387--playButton{width: " + $params["playButtonMobileSize"] + ";height: " + $params["playButtonMobileSize"] + "}\n" + $id + " .VideoPlayer4111471387--playButton circle{stroke: " + $params["fontColor"] + "}\n" + $id + " .VideoPlayer4111471387--playButton path{fill: " + $params["fontColor"] + "}\n";
};
...
var _VideoPlayer = __webpack_require__(/*! ./VideoPlayer */ 660);

var _VideoPlayerSt = __webpack_require__(/*! ./VideoPlayer.st.css */ 370);
...
var _santaComponents = __webpack_require__(/*! santa-components */ 13);

var _video = __webpack_require__(/*! wix-ui-core/video */ 661);

var _playbackBiModule = __webpack_require__(/*! @wix/playback-bi-module */ 674);

var _events = __webpack_require__(/*! ./bi/events */ 690);

var _videoPlayerBehaviors = __webpack_require__(/*! ./behaviors/videoPlayerBehaviors */ 691);

var _VideoPlayerSt = __webpack_require__(/*! ./VideoPlayer.st.css */ 370);

var _VideoPlayerSt2 = _interopRequireDefault(_VideoPlayerSt);

var _playButtonIcon = __webpack_require__(/*! ./playButtonIcon */ 692);
...
var santaVideoPlayer = exports.santaVideoPlayer = (0, _createReactClass2.default)({
  ...
  getPosterUrl: function getPosterUrl() {
    var posterUrl = _lodash2.default.get(this.props, 'compData.posterUrl');
...
module.exports = __webpack_require__(/*! ./dist/src/components/video */ 662);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Video_1 = __webpack_require__(/*! ./Video */ 663);
...
var React = __webpack_require__(/*! react */ 0);
var players_1 = __webpack_require__(/*! ./players */ 664);
var Video_st_css_1 = __webpack_require__(/*! ./Video.st.css */ 75);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Playable_1 = __webpack_require__(/*! ./Playable */ 665);
var YouTube_1 = __webpack_require__(/*! ./YouTube */ 667);
var Facebook_1 = __webpack_require__(/*! ./Facebook */ 670);
var Vimeo_1 = __webpack_require__(/*! ./Vimeo */ 671);
var Twitch_1 = __webpack_require__(/*! ./Twitch */ 672);
var DailyMotion_1 = __webpack_require__(/*! ./DailyMotion */ 673);
// @TODO enum ?
...
var tslib_1 = __webpack_require__(/*! tslib */ 3);
var React = __webpack_require__(/*! react */ 0);
var eventemitter3_1 = __webpack_require__(/*! eventemitter3 */ 57);
var classnames_1 = __webpack_require__(/*! classnames */ 5);
var isString = __webpack_require__(/*! lodash/isString */ 91);
var isArray = __webpack_require__(/*! lodash/isArray */ 175);
var playable_1 = __webpack_require__(/*! playable */ 366);
var constants_1 = __webpack_require__(/*! ../constants */ 74);
...
var PlayablePlayer = /** @class */ (function (_super) {
    ...
    PlayablePlayer.prototype._renderCover = function () {
        var _a;
        var _b = this.props, showTitle = _b.showTitle, title = _b.title, poster = _b.poster, hideOverlay = _b.hideOverlay, playButton = _b.playButton, playing = _b.playing;
        ...
        return (React.createElement("div", { className: classnames_1.default(Video_st_css_1.default.cover, (_a = {},
...
__webpack_require__(/*! setimmediate */ 172);
...
var eventemitter3_1 = __webpack_require__(/*! eventemitter3 */ 57);
var isString = __webpack_require__(/*! lodash/isString */ 91);
var utils_1 = __webpack_require__(/*! ../utils */ 105);
var constants_1 = __webpack_require__(/*! ../constants */ 74);
var playerHOC_1 = __webpack_require__(/*! ./playerHOC */ 92);
var Video_st_css_1 = __webpack_require__(/*! ../Video.st.css */ 75);
...
Object.defineProperty(exports, "__esModule", { value: true });
var originalLoadjs = __webpack_require__(/*! loadjs */ 669);
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./playback-bi-module */ 675));
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var playable_1 = __webpack_require__(/*! playable */ 366);
var web_bi_logger_1 = __importDefault(__webpack_require__(/*! @wix/web-bi-logger */ 676));
var bi_logger_video_platform_1 = __importDefault(__webpack_require__(/*! @wix/bi-logger-video-platform */ 689));
...
var _tracker = __webpack_require__(/*! ./lib/tracker */ 677);

var tracker = _interopRequireWildcard(_tracker);

var _logger = __webpack_require__(/*! ./logger */ 679);
...
var _navigator = __webpack_require__(/*! ./navigator */ 678);
...
var _wixBiLoggerClient = __webpack_require__(/*! @wix/wix-bi-logger-client */ 680);

var _env = __webpack_require__(/*! ./lib/env */ 106);

var env = _interopRequireWildcard(_env);

var _publishers = __webpack_require__(/*! ./lib/publishers */ 687);
...
var BiLoggerClientFactory = __webpack_require__(/*! ./bi-logger-factory */ 681);
var BiLogger = __webpack_require__(/*! ./bi-logger */ 369);
...
var debounce = __webpack_require__(/*! ./debounce */ 686);
...
var _transport = __webpack_require__(/*! ./transport */ 688);
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Video3333624439",
  {"root":"Video3333624439--root","playerContainer":"Video3333624439--playerContainer","cover":"Video3333624439--cover","transparentOverlay":"Video3333624439--transparentOverlay","overlay":"Video3333624439--overlay","title":"Video3333624439--title"},
  "",
  1,
  /*! ../node_modules/wix-ui-core/dist/src/components/video/Video.st.css */ 75
);
...
var tslib_1 = __webpack_require__(/*! tslib */ 3);
var React = __webpack_require__(/*! react */ 0);
var uniqueId = __webpack_require__(/*! lodash/uniqueId */ 77);
var constants_1 = __webpack_require__(/*! ../constants */ 74);
